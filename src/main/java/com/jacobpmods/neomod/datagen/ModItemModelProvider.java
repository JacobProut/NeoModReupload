...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        basicItem(ModItems.MAGMA_MINER_POTION.get());
...
*/
        ...
        saplingItem(ModBlocks.GILDED_SAPLING);
        ...
        withExistingParent(ModItems.SKELETAL_WOLF_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        ...
        handheldItem(ModItems.GOD_SWORD);
