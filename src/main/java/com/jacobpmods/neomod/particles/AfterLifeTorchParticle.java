...
public class AfterLifeTorchParticle extends BaseAshSmokeParticle {

    protected AfterLifeTorchParticle(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, float quadSizeMultiplier, SpriteSet sprites) {
    ...
    public void tick() {
        super.tick();
        //Original colors
       /* int endingPackedColor = 16052832; // Hexadecimal color: #F4B630
        int startingPackedColor = 16777215; // Hexadecimal color: #FFFFFF*/
        int startingPackedColor = 0xFFD3D3FF; // Light purple (R: 211, G: 211, B: 255)
        int endingPackedColor = 0xFF6A0DAD;  // Dark purple (R: 106, G: 13, B: 173)
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new AfterLifeTorchParticle(level, x, y, z, 0.0, 0.0, 0.0, 1.0F, this.sprites);
        }
    }
}
