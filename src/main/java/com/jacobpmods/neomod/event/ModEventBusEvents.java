...
import com.jacobpmods.neomod.entity.client.skeletal.wolf.SkeletalWolfModel;
...
public class ModEventBusEvents {
    ...
    public static void registerLayers(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(ModModelLayers.SKELETAL_WOLF, SkeletalWolfModel::createBodyLayer);
    ...
    public static void registerAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(ModEntities.SKELETAL_WOLF.get(), SkeletalWolfEntity.createAttributes().build());
    }
    ...
    public static void registerSpawnPlacements(RegisterSpawnPlacementsEvent event) {
        ...
        //                                 * Neutral Mobs *
        event.register(ModEntities.SKELETAL_WOLF.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                Wolf::checkAnimalSpawnRules, RegisterSpawnPlacementsEvent.Operation.REPLACE);
