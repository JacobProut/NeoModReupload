...
import com.jacobpmods.neomod.item.custom.potions.MagmaMinerPotion;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> MAGMA_MINER_POTION = ITEMS.register("magma_miner_potion", () -> new MagmaMinerPotion(new Item.Properties()));
