...
public class NightTimeExplorerPotion extends Item {
    public NightTimeExplorerPotion(Properties properties) {
        super(properties.food(new FoodProperties.Builder()
                .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 3600, 0), 1.0f) // 100% chance of Speed I for 3 minute
                .effect(() -> new MobEffectInstance(MobEffects.NIGHT_VISION, 3600, 0), 1.0f) // 100% chance of Strength I for 3 minute
                .build()));
    }
    public NightTimeExplorerPotion(Properties properties, boolean II) {
        super(properties.food(new FoodProperties.Builder()
                .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 1800, 1), 1.0f) // 100% chance of Speed II for 90 seconds
                .effect(() -> new MobEffectInstance(MobEffects.NIGHT_VISION, 4800, 0), 1.0f) // 100% chance of Night Vision for 4 Minutes
                .build()));
    }
