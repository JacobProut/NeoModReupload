...
public class MixerMenu extends AbstractContainerMenu {
    ...
    public MixerMenu(int containerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.addSlot(new SlotItemHandler(this.blockEntity.itemStackHandler, 0,80,9));
        this.addSlot(new SlotItemHandler(this.blockEntity.itemStackHandler, 1,62,37));
        this.addSlot(new SlotItemHandler(this.blockEntity.itemStackHandler, 2,98,37));
        this.addSlot(new SlotItemHandler(this.blockEntity.itemStackHandler, 3,127,61));
