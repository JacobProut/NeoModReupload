...
public class ModModelLayers {
    ...
    public static final ModelLayerLocation SKELETAL_WOLF = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(FirstNeoMod.MOD_ID, "skeletal_wolf"), "main");
}
