...
public class SkeletalEndermanAnimations {
    public static final AnimationDefinition SKELETAL_ENDERMAN_WALK = AnimationDefinition.Builder.withLength(0.7083F).looping()
